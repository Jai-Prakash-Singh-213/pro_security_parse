...
class pro_similar(object):
	...
	if tag_dte_main.startswith("From") is True:
        ...
        #self.dte_styl = "from=2013|10&to=2014|3"
        self.dte_styl = "from=%s|%s&to=%s|%s" %(tag_dte_fst_yr, tag_dte_fst_mn_int, 
                                                tag_dte_snd_yr, tag_dte_snd_mn_int)
    ...
    def trafic_pd_org_all_src(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetTrafficSourcesSearchTsv?selectedTab=all&key="+ self.domain +"&country=999&"+ self.dte_styl +"&orderby=Share%20desc"
    ...
    def trafic_org_all_src(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetTrafficSourcesSearchTsv?selectedTab=all&groupedKeywords_filters=wordCount;==;1&Keywords_filters=OP;==;0&key="+ self.domain +"&country=999&"+ self.dte_styl +"&filter=OP;==;0&orderby=Share%20desc" 
    ...
    def trafic_p_all_src(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetTrafficSourcesSearchTsv?selectedTab=all&Keywords_filters=OP;==;1&key="+ self.domain +"&country=999&"+ self.dte_styl +"&filter=OP;==;1&orderby=Share%20desc"
    ...
    def trf_po_srch_grp1(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetTrafficSourcesGroupedKeywordsTsv?selectedTab=grouped&groupedKeywords_filters=wordCount;==;1+excludeBranded;notcontains;"+ self.dmn +"&key="+ self.domain +"&country=999&"+ self.dte_styl +"&filter=wordCount;==;1,searchTerm;notcontains;%22"+ self.dmn +"%22&orderby=Share%20desc"
    ...
    def trf_po_srch_grp2(self):
        ...
        link2a = "http://pro.similarweb.com/export/analysis/GetTrafficSourcesGroupedKeywordsTsv?selectedTab=grouped&groupedKeywords_filters=wordCount;==;2+excludeBranded;notcontains;"+ self.dmn +"&key="+ self.domain +"&country=999&"+ self.dte_styl +"&filter=wordCount;==;2,searchTerm;notcontains;%22"+ self.dmn+"%22&orderby=Share%20desc"
    ...
    def trf_o_srch_grp2(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetTrafficSourcesGroupedKeywordsTsv?selectedTab=grouped&Keywords_filters=OP;==;0+excludeBranded;notcontains_multi;"+ self.dmn +"&groupedKeywords_filters=wordCount;==;2+excludeBranded;notcontains;"+ self.dmn +"&key="+ self.domain +"&country=999&"+ self.dte_styl +"&filter=wordCount;==;2,searchTerm;notcontains;%22"+ self.dmn +"%22&orderby=Share%20desc"
    ...
    def trf_po_srch_grp3(self):
         ...
         link3a = "http://pro.similarweb.com/export/analysis/GetTrafficSourcesGroupedKeywordsTsv?selectedTab=grouped&groupedKeywords_filters=wordCount;==;3+excludeBranded;notcontains;"+ self.dmn +"&key="+ self.domain +"&country=999&"+ self.dte_styl +"&filter=wordCount;==;3,searchTerm;notcontains;%22"+ self.domain +"%22&orderby=Share%20desc"
    ...
    def trf_o_srch_grp3(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetTrafficSourcesGroupedKeywordsTsv?selectedTab=grouped&Keywords_filters=OP;==;0+excludeBranded;notcontains_multi;"+ self.dmn +"&groupedKeywords_filters=wordCount;==;3+excludeBranded;notcontains;"+ self.dmn +"&key="+ self.domain + "&country=999&"+ self.dte_styl +"&filter=wordCount;==;3,searchTerm;notcontains;%22"+ self.dmn +"%22&orderby=Share%20desc"
	...
	link2 = "http://pro.similarweb.com/export/analysis/GetOutgoingTsv?key="+ self.domain +"&country=999&"+ self.dte_styl +"&orderby=Share%20desc"
	...
	link1a = "http://pro.similarweb.com/export/analysis/GetSubDomainsTsv?key="+ self.domain +"&country=999&"+ self.dte_styl +"&orderby=Share%20desc"
    ...
    def web_cont_sub_pop_page(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetPopularPagesTsv?selectedTab=pages&key="+ self.domain +"&country=999&"+ self.dte_styl +"&orderby=Share%20desc"
	...
	link1a = "http://pro.similarweb.com/export/analysis/GetLeadingFoldersTsv?selectedTab=folders&key="+ self.domain +"&country=999&"+ self.dte_styl +"&orderby=Share%20desc"
    ...
    def compititor_simil(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetCompetitorsSimilarsitesTsv?key="+ self.domain +"&country=999&"+ self.dte_styl +"&orderby=Affinity%20desc"
    ...
    def compititor_srch_orgnic(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetOrganicSearchCompetitorsTsv?selectedTab=organic&key="+ self.domain +"&country=999&"+ self.dte_styl +"&orderby=Score%20desc"
    ...
    def compititor_srch_pd(self):
        ...
        link1a = "http://pro.similarweb.com/export/analysis/GetPaidSearchCompetitorsTsv?selectedTab=paid&key="+ self.domain +"&country=999&"+ self.dte_styl +"&orderby=Score%20desc"
...
def supermain():
    f = open("nexusdialer_entry2.txt", "a+")
