...
class pro_similar(object):
    ...
    def trafic_pd_org_all_src(self):
        ...
        print [self.trafic_pd_org_all_src_file, self.trafic_pd_org_all_src_visit[0].strip()]        
    ...
    def trafic_org_all_src(self):
        ...
        print [self.trafic_org_all_src_file, self.trafic_org_all_src_visit[0].strip()]
    ...
    def trafic_p_all_src(self):
        ...
        print [self.trafic_p_all_src_file, self.trafic_p_all_src_visit[0].strip()]
	...
	print [self.traff_dest_file, self.traff_dest_visit]
    ...
    def web_cont_sub_pop_page(self):
        ...
        print [self.web_cont_sub_pop_page_file]
	...
	print [self.web_cont_sub_led_folder_file]
    ...
    def compititor_simil(self):
        ...
        print [self.compititor_simil_file]
    ...
    def compititor_srch_orgnic(self):
        ...
        print [self.compititor_srch_orgnic_file]
    ...
    def compititor_srch_pd(self):
        ...
        print [self.compititor_srch_pd_file]
...
def supermain():
    ...
    #obj.web_cont_sub_led_folder()
    #obj.compititor_simil()
    #obj.compititor_srch_orgnic()
    #obj.compititor_srch_pd()
