...
class pro_similar(object):
    ...
    def trf_srch_grp_1_2_3(self, grp_link):
        ...
        #soup = BeautifulSoup(page, "html.parser")
        #tag_csv_a = soup.find("a", attrs={"title":"Download CSV"})

        #csv_a = "%s%s" %("http://pro.similarweb.com", tag_csv_a.get("href"))
        ...
        tree = html.fromstring(page)
        tag_csv_a = tree.xpath("/html/body/div[2]/div[3]/section/div/div[2]/div/div/div/div[2]/div/form/a")
        print tag_csv_a
        
        tag_csv_a = tree.xpath("/html/body/div[2]/div[3]/section/div/div[2]/div/div/div/div[2]/div/form/a/@href")
        print tag_csv_a

        csv_a = "%s%s" %("http://pro.similarweb.com", tag_csv_a[0])
        print csv_a
        self.driver.get(csv_a)
