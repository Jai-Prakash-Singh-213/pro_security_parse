...
class pro_similar(object):
	...
	#trafic_pd_org_all_src_visit = soup.find("div", attrs={"class":"count c-blue ng-binding"})
	#trafic_pd_org_all_src_visit = str(trafic_pd_org_all_src_visit.get_text()).replace(",", "-").strip()

	#trafic_pd_org_all_src_prcnt = soup.find("div", attrs={"class":"sw-percent"})
	#trafic_pd_org_all_src_prcnt = str(trafic_pd_org_all_src_prcnt.get_text()).replace("\n", " ").replace("\r", " ").strip()
	...
	self.trafic_pd_org_all_src_fle = self.find_file(os.getcwd(), "*.csv")
        ...
        #print trafic_pd_org_all_src_prcnt
    ...
    def trf_srch_grp(self):    
        ...
        #link1 = urllib.unquote(link1)
        #link1 = link1 %(self.domain, self.dte, dmn)
        ...
        #link2 = urllib.unquote(link2)
        #link2 = link2 %(self.domain, self.dte, dmn)
        ...
        #link3 = urllib.unquote(link3)
        #link3 = link3 %(self.domain, self.dte, dmn)
